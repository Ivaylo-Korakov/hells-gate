        ...
        private List<Item> BuildPotions()
        {
            List<Item> potions = new List<Item>() {
                ...
                new Item(id: 0, title: "Small Red Pot", description: "A potion that heals 10 HP",
                    quality: ItemQuality.Common, type: ItemType.Potion, stackSize: 1, maxStackSize: 3, isStackable: false,
                    isSellable: false, sellPrice: 2, buyPrice: 4,
                    stats: new Dictionary<string, int>() { { "Health", 10 } }, effects: new List<ItemEffect>()
                ),
                new Item(id: 1, title: "Small Blue Pot", description: "A potion that restores 10 Mana",
                    quality: ItemQuality.Common, type: ItemType.Potion, stackSize: 1, maxStackSize: 3, isStackable: false,
                    isSellable: false, sellPrice: 2, buyPrice: 4,
                    stats: new Dictionary<string, int>() { { "Mana", 10 } }, effects: new List<ItemEffect>()
                ),
                new Item(id: 2, title: "Small Green Pot", description: "A potion that restores 10 Stamina",
                    quality: ItemQuality.Common, type: ItemType.Potion, stackSize: 1, maxStackSize: 3, isStackable: false,
                    isSellable: false, sellPrice: 2, buyPrice: 4,
                    stats: new Dictionary<string, int>() { { "Stamina", 10 } }, effects: new List<ItemEffect>()
                ),

                // == Rare Potions ==
                new Item(id: 3, title: "Medium Red Pot", description: "A potion that heals 25 HP",
                    quality: ItemQuality.Rare, type: ItemType.Potion, stackSize: 1, maxStackSize: 5, isStackable: false,
                    isSellable: false, sellPrice: 5, buyPrice: 10,
                    stats: new Dictionary<string, int>() { { "Health", 25 } }, effects: new List<ItemEffect>()
                ),
                new Item(id: 4, title: "Medium Blue Pot", description: "A potion that restores 25 Mana",
                    quality: ItemQuality.Rare, type: ItemType.Potion, stackSize: 1, maxStackSize: 5, isStackable: false,
                    isSellable: false, sellPrice: 5, buyPrice: 10,
                    stats: new Dictionary<string, int>() { { "Mana", 25 } }, effects: new List<ItemEffect>()
                ),
                new Item(id: 5, title: "Medium Green Pot", description: "A potion that restores 25 Stamina",
                    quality: ItemQuality.Rare, type: ItemType.Potion, stackSize: 1, maxStackSize: 5, isStackable: false,
                    isSellable: false, sellPrice: 5, buyPrice: 10,
                    stats: new Dictionary<string, int>() { { "Stamina", 25 } }, effects: new List<ItemEffect>()
                ),

                // == Legendary Potions ==
                new Item(id: 6, title: "Large Red Pot", description: "A potion that heals 50 HP",
                    quality: ItemQuality.Legendary, type: ItemType.Potion, stackSize: 1, maxStackSize: 10, isStackable: false,
                    isSellable: false, sellPrice: 10, buyPrice: 20,
                    stats: new Dictionary<string, int>() { { "Health", 50 } }, effects: new List<ItemEffect>()
                ),
                new Item(id: 7, title: "Large Blue Pot", description: "A potion that restores 50 Mana",
                    quality: ItemQuality.Legendary, type: ItemType.Potion, stackSize: 1, maxStackSize: 10, isStackable: false,
                    isSellable: false, sellPrice: 10, buyPrice: 20,
                    stats: new Dictionary<string, int>() { { "Mana", 50 } }, effects: new List<ItemEffect>()
                ),
                new Item(id: 8, title: "Large Green Pot", description: "A potion that restores 50 Stamina",
                    quality: ItemQuality.Legendary, type: ItemType.Potion, stackSize: 1, maxStackSize: 10, isStackable: false,
                    isSellable: false, sellPrice: 10, buyPrice: 20,
                    stats: new Dictionary<string, int>() { { "Stamina", 50 } }, effects: new List<ItemEffect>()
                ),
            };
        ...
        public List<Item> BuildMagicWeapons()
        {
            List<Item> magicWeapons = new List<Item>() {
                ...
                new Item(id: 9, title: "Common Magic Sword", description: "A common magic sword",
                    quality: ItemQuality.Common, type: ItemType.Weapon, stackSize: 1, maxStackSize: 1, isStackable: false,
                    isSellable: false, sellPrice: 10, buyPrice: 20,
                    stats: new Dictionary<string, int>() { { "Damage", 10 } }, effects: new List<ItemEffect>()
                ),
                ...
                new Item(id: 12, title: "Rare Magic Sword", description: "A rare magic sword",
                    quality: ItemQuality.Rare, type: ItemType.Weapon, stackSize: 1, maxStackSize: 1, isStackable: false,
                    isSellable: false, sellPrice: 20, buyPrice: 40,
                    stats: new Dictionary<string, int>() { { "Damage", 20 } }, effects: new List<ItemEffect>()
                ),
                ...
                new Item(id: 15, title: "Legendary Magic Sword", description: "A legendary magic sword",
                    quality: ItemQuality.Legendary, type: ItemType.Weapon, stackSize: 1, maxStackSize: 1, isStackable: false,
                    isSellable: false, sellPrice: 40, buyPrice: 80,
                    stats: new Dictionary<string, int>() { { "Damage", 40 } }, effects: new List<ItemEffect>()
                ),
        ...
        public List<Item> BuildMagicArmor()
        {
            List<Item> magicArmor = new List<Item>() {
                ...
                new Item(id: 18, title: "Common Magic Helmet", description: "A common magic helmet",
                    quality: ItemQuality.Common, type: ItemType.Armor, stackSize: 1, maxStackSize: 1, isStackable: false,
                    isSellable: false, sellPrice: 10, buyPrice: 20,
                    stats: new Dictionary<string, int>() { { "Armor", 10 } }, effects: new List<ItemEffect>()
                ),
                ...
                new Item(id: 22, title: "Rare Magic Helmet", description: "A rare magic helmet",
                    quality: ItemQuality.Rare, type: ItemType.Armor, stackSize: 1, maxStackSize: 1, isStackable: false,
                    isSellable: false, sellPrice: 20, buyPrice: 40,
                    stats: new Dictionary<string, int>() { { "Armor", 20 } }, effects: new List<ItemEffect>()
                ),
                ...
                new Item(id: 26, title: "Legendary Magic Helmet", description: "A legendary magic helmet",
                    quality: ItemQuality.Legendary, type: ItemType.Armor, stackSize: 1, maxStackSize: 1, isStackable: false,
                    isSellable: false, sellPrice: 40, buyPrice: 80,
                    stats: new Dictionary<string, int>() { { "Armor", 40 } }, effects: new List<ItemEffect>()
                ),
        ...
        public List<Item> BuildMagicSpells()
        {
            List<Item> magicSpells = new List<Item>()
            {
                ...
                new Spell(id: 30, title: "Common Magic Spell", description: "A common magic spell",
                    quality: ItemQuality.Common, type: ItemType.Spell, stackSize: 1, maxStackSize: 1, isStackable: false,
                    isSellable: false, sellPrice: 10, buyPrice: 20,
                    stats: new Dictionary<string, int>() { { "Damage", 10 } }, effects: new List<ItemEffect>(), spellType: SpellType.Fire
                ),
                new Spell(id: 31, title: "Common Magic Spell", description: "A common magic spell",
                    quality: ItemQuality.Common, type: ItemType.Spell, stackSize: 1, maxStackSize: 1, isStackable: false,
                    isSellable: false, sellPrice: 10, buyPrice: 20,
                    stats: new Dictionary<string, int>() { { "Damage", 10 } }, effects: new List<ItemEffect>(), spellType: SpellType.Ice
                ),
                new Spell(id: 32, title: "Common Magic Spell", description: "A common magic spell",
                    quality: ItemQuality.Common, type: ItemType.Spell, stackSize: 1, maxStackSize: 1, isStackable: false,
                    isSellable: false, sellPrice: 10, buyPrice: 20,
                    stats: new Dictionary<string, int>() { { "Damage", 10 } }, effects: new List<ItemEffect>(), spellType: SpellType.Lightning
                ),
                new Spell(id: 33, title: "Common Magic Spell", description: "A common magic spell",
                    quality: ItemQuality.Common, type: ItemType.Spell, stackSize: 1, maxStackSize: 1, isStackable: false,
                    isSellable: false, sellPrice: 10, buyPrice: 20,
                    stats: new Dictionary<string, int>() { { "Damage", 10 } }, effects: new List<ItemEffect>(), spellType: SpellType.Poison
                ),
